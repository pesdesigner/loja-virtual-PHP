...
<?php
    ...
    if(isset($_POST["nometransportadora"])){
      ...
      // obj para excluir
      $del = "DELETE FROM transportadoras ";
      $del .= "WHERE transportadoraID = {$tID} ";
...
<div class="container main_cadastro">
    ...
    <h5 class="center">Excluir transportadora</h5>
    <div class="divider"></div>

    <div class="row">
    <form class="s6 offset-s3" action="del_trans.php" method="post">
    ...
    <button class="btn waves-effect waves-light input-field col s12" type="submit">Excluir transportadora
    </button>
